...
All the environments are registered in the `navigation_lab` extension. They start
...
import navigation_lab.tasks  # noqa: F401


def main():
    """Print all environments registered in `navigation_lab` extension."""
